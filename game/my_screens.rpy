    ...
    vbox:
        ...
        hbox:
            ...
            imagebutton:
                ...
                action [Show("browserWindowSubscribeFake"),Call("addPoints",5,"point_sociaux","","","","Bravo ! µ Il est parfois bon de ne pas trop en dire.µLes champs obligatoires (indiqués par un astérisque) sont suffisants. µTrop de précision sur votre identité contribue à divulguer tes données personnelles d’identité.µ Des grandes Sociétés comme ici DATABOOK récoltent ces données et les revendent ensuite, µsoit à des fins de marketing soit à d’autres sociétés parfois peu scrupuleuses.","browserLabelFeed")]
            imagebutton:
                idle "UI/browser/trueInformation_idle.png"
                hover "UI/browser/trueInformation_hover.png"
                action [Show("browserWindowSubscribeTrue"),Call("addPoints",-5,"point_sociaux","","","Evites de donner trop d’informations ou de vraies informations. Les champs obligatoires (indiqués par un astérisque) sont suffisants.µCela contribue à divulguer tes données personnelles d’identité. µDes grandes Sociétés comme ici DATABOOK récoltent ces données et les revendent ensuite, µsoit à des fins de marketing soit à d’autres sociétés parfois peu scrupuleuses. ","","browserLabelFeed")]
        #add "UI/browser/feedDataBook.png"
